...
def make_bcc_NN(e):
 e=np.transpose(e)
 A=[[0.5, -0.5, -0.5],[-0.25, -0.75, -0.25],[-0.5, -0.5, 0.5],[0.25, -0.25, 0.25],   
    [0.5, -0.5, -0.5],[0.75, 0.25, -0.25],[0.5, 0.5, 0.5],[0.25, -0.25, 0.25],
    [-0.5, -0.5, 0.5],[-0.25, 0.25, 0.75],[0.5, 0.5, 0.5],[0.25, 0.75, 0.25], 
    [-0.5, 0.5, 0.5],[-0.25, 0.25, 0.75],[0.5, 0.5, 0.5],[0.75, 0.25, -0.25],
    ...
    [0.5, -0.5, -0.5]]
 WRZ=[[ i[0]*e[0][m]+i[1]*e[1][m]+i[2]*e[2][m] for m in range(3)] for i in A]
 h=open('FS_NN.dat','w')
 for i in WRZ:
  for m in i:
   h.write( str(m)+' ' )
